            ...
            <nav class="navbar navbar-default yamm navbar-static-top" role="navigation" id="header">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a id="ar-brand" class="navbar-brand" href="index.html">SKKP <span>STT INDONESIA</span></a>
                    </div> <!-- navbar-header -->

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="pull-right">
                            <a onclick="openNav()" class="sb-icon-navbar sb-toggle-right"><i class="fa fa-bars"></i></a>
                    </div>
